...
import { apiUrl, postTemplate } from '../lib/rest/restApi'
    ...
    <div className="w-screen min-h-[calc(100vh-6rem)] flex flex-col gap-8 bg-gray-100">
      ...
      <div className="bg-surface-subtle p-8 min-h-[34rem] items-center justify-center flex flex-col md:flex-row gap-8">
        ...
        <div className="border border-border-default bg-white rounded-lg w-11/12 md:w-[17rem] md:h-[22rem] p-4 pt-8 flex items-center flex-col gap-8">
          ...
          <div>
            ...
            <p>
              På Aksel kan du lese om datadrevet produktutvikling. En
              inspirasjon for å komme i gang med målinger i ditt team?
            </p>
          </div>
        </div>
        ...
        <div className="border border-border-default bg-white rounded-lg w-11/12 md:w-[17rem] md:h-[22rem] p-4 pt-8 flex items-center flex-col gap-8">
          ...
          <div>
            <Heading level="2" size="small">
              <Link href="https://docs.knada.io/">Hvordan komme i gang?</Link>
            </Heading>
            <p>
              Er du usikker på hva du trenger for å lage dataprodukter, eller
              hvordan du får dashbaord? Dokumentasjonen til plattformen ligger
              her.
            </p>
          </div>
        </div>
        ...
        <div className="border border-border-default bg-white rounded-lg w-11/12 md:w-[17rem] md:h-[22rem] p-4 pt-8 flex items-center flex-col gap-8">
          ...
          <div>
            ...
            <p>
              For at folk skal være trygge rundt deling og bruk av data med
              personopplysninger, har vi forsøkt å svare på noen spørsmål.
            </p>
          </div>
        </div>
      </div>
      <div className="flex flex-col items-center gap-8 w-11/12 self-center pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full md:w-[32rem]">
          ...
          <Button
            onClick={() => {
              postTemplate(`${apiUrl()}/workstations/async`, {
                machineType: 'n2d-standard-8',
                containerImage: 'image',
              })
            }}
          >
            Test Async Create Workstation
          </Button>
        </div>
      </div>
    </div>
